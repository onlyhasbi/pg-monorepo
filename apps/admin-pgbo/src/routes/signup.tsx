...
function SignupPage() {
  ...
  return (
    <div className="relative min-h-dvh flex flex-col items-center justify-center bg-slate-50 overflow-hidden px-6 font-sans">
      ...
      >
        <AnimatePresence>
          {!effectiveLockoutTime && !effectiveIsUnlocked && (
            <motion.div
            ...
            >
              <motion.div
                ...
                className="p-3 bg-[#000856] rounded-[var(--radius-card)] shadow-sm border border-slate-100"
              >
                <OptimizedImage
                  src="/5g.webp"
                  alt="Logo"
              ...
              <CardContent className="p-0 flex flex-col h-full">
                <div className="p-6 sm:px-10 pb-8 pt-10">
                  <SignUpForm
                    ...
                    onLoginSuccess={() => navigate({ to: "/overview" })}
                  />
        ...
        <AuthSecurityNote
          lockoutTime={effectiveLockoutTime}
