...
import { AndroidIcon, AppleIcon } from "../icons/SocialIcons";
                  ...
                  >
                    {currentStep.actions.map((action) => (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group inline-flex items-center gap-3 bg-slate-950 hover:bg-slate-900 text-white px-6 py-3.5 rounded-2xl transition-all duration-300 hover:shadow-xl hover:shadow-slate-900/20 hover:-translate-y-0.5"
                      >
                        {action.icon === "android" ? (
